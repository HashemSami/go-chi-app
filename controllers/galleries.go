...
func (g Galleries) Index(w http.ResponseWriter, r *http.Request) {
	// we can add a new Gallery struct so we can have a layer that can
	// defined a specific variables we can set instead of sending the
	// the hole gallery object from the database
	type Gallery struct {
		ID    int
		Title string
	}
...
func (g Galleries) galleriesByID(w http.ResponseWriter, r *http.Request, opts ...galleryOpt) (*models.Gallery, error) {
...
func (g Galleries) userMustOwnGallery(w http.ResponseWriter, r *http.Request, gallery *models.Gallery) error {
